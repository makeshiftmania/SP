// rti-generator.js - RTI Generation Popup Component with Success Popup
...
(function() {
    ...
    const SUCCESS_POPUP_POSITIONING = {
        ...
        ppdocNumberField: {
            ...
            top: 48,       // ← ADJUST THIS: distance from top
    ...
    function createInputOverlays() {
        ...
        // RTI Tag Number field (auto-populated, read-only but copyable)
        ...
        rtiTagField.style.color = '#666666';
        rtiTagField.style.cursor = 'text'; // Allow text cursor for copying
    ...
    function createPPDOCNumberField() {
        console.log('[RTI-GENERATOR] Creating PPDOC number field');
        ...
        const ppdocField = document.createElement('div');
        ppdocField.id = 'ppdoc-number-display';
        ppdocField.textContent = ppdocNumber;
        
        // Apply all the configurable styling
        ppdocField.style.cssText = `
            position: absolute;
            left: ${fieldConfig.left}px;
            top: ${fieldConfig.top}px;
            width: ${fieldConfig.width}px;
            height: ${fieldConfig.height}px;
            font-size: ${fieldConfig.fontSize};
            font-family: ${fieldConfig.fontFamily};
            font-weight: ${fieldConfig.fontWeight};
            ...
            line-height: ${fieldConfig.height}px;
            user-select: text;
            cursor: text;
        `;
        
        // Add positioning helper if in positioning mode
        addPositioningHelper(ppdocField, 'PPDOC-FIELD');
        
        console.log('[RTI-GENERATOR] PPDOC field created with value:', ppdocNumber);
        return ppdocField;
    }
