// replacement-key-faulty-handler.js - Updated with popup focus and tab order fixes
window.faultyKeyHandler = (function() {
    ...
    function initialize() {
        ...
        setupTabOrder(); // NEW: Set up custom tab order
        
        console.log('[FAULTY-KEY] Initialization complete');
    }

    // NEW FUNCTION: Set up custom tab order
    function setupTabOrder() {
        console.log('[FAULTY-KEY] Setting up custom tab order...');
        ...
        if (initKeyCredit && generateRTIButton) {
            ...
            console.log('[FAULTY-KEY] Tab order set up: initKeyCredit -> btn-generaterti');
        } else {
    ...
    function showConfirmationPopup() {
        ...
        // NEW: Add keyboard support for popup
        ...
        // NEW: Focus the popup immediately so Enter key works
        setTimeout(() => {
            popup.focus();
